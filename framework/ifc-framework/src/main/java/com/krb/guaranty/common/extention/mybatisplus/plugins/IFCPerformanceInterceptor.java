package com.krb.guaranty.common.extention.mybatisplus.plugins;
 ...
 *
 * 完全参考 PerformanceInterceptor{@link com.baomidou.mybatisplus.extension.plugins.PerformanceInterceptor}
 * 在writesql开启的时候把debug换成warn
 *
...
public class IFCPerformanceInterceptor implements Interceptor {

    private static final Log logger = LogFactory.getLog(IFCPerformanceInterceptor.class);
